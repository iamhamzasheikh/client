    ...
    <motion.form
      ...
      {!isImageLoaded &&
        <div className="flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0 mt-10 rounded-full">
          ...
          <button
            type="submit"
            className="bg-zinc-900 p-4 sm:px-16 rounded-full">Generate</button>
        </div>
      }

      {isImageLoaded &&
        <div className="flex gap-7 flex-wrap justify-center text-white text-sm p-0.5 mt-10 rounded-full">
